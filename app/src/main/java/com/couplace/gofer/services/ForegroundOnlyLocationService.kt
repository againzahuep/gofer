 ...
 */
package com.couplace.gofer.services
...
import com.couplace.gofer.utils.toText
...
class ForegroundOnlyLocationService : Service() {
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        // we do nothing.
        if (!configurationChange && Utils.getLocationTrackingPref(this)) {
    ...
    fun subscribeToLocationUpdates() {
        ...
        Utils.saveLocationTrackingPref(this, true)
        ...
        try {
            ...
            Utils.saveLocationTrackingPref(this, false)
        }
    }
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val launchActivityIntent = Intent(this, ProductActivity::class.java)
        ...
        return notificationCompatBuilder
            ...
            .addAction(
                R.drawable.ic_launch, getString(R.string.app_name),
